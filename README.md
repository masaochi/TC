...
- [FFTW library](https://www.quantum-espresso.org/) (Note: If you compiled FFTW with the Intel compiler, please compile TC++ with the Intel compiler to avoid some errors.)
