...
- `FFTW library <https://www.fftw.org/>`_ (Note: if you compiled FFTW with the Intel compiler, please compile TC++ with the Intel compiler to avoid some errors.)
...
and edit Makefile to specify the required libraries shown above (except Quantum ESPRESSO).
