...
/*
        tc3a2(parallelization,
              ...
              plane_wave_basis, bloch_states,
              phi, H3phi, ost);
        if (am_i_mpi_rank0) { my_clock.print_time_from_save(ost, "calculating the tc-3body term (3a2)"); }
      
        tc3a4(parallelization,
              method,
              crystal_structure,
              symmetry,
              potentials, spin, kpoints,
              plane_wave_basis, bloch_states,
              phi, H3phi, ost);
        if (am_i_mpi_rank0) { my_clock.print_time_from_save(ost, "calculating the tc-3body term (3a4)"); }

        tc3b2(parallelization,
              method,
              crystal_structure,
              symmetry,
              potentials, spin, kpoints,
              plane_wave_basis, bloch_states,
              phi, H3phi, ost);
        if (am_i_mpi_rank0) { my_clock.print_time_from_save(ost, "calculating the tc-3body term (3b2)"); }

        tc3b5(parallelization,
              method,
              crystal_structure,
              symmetry,
              potentials, spin, kpoints,
              plane_wave_basis, bloch_states,
              phi, H3phi, ost);
        if (am_i_mpi_rank0) { my_clock.print_time_from_save(ost, "calculating the tc-3body term (3b5)"); }
*/
/*
        tc3a3(parallelization,
              method,
              crystal_structure,
              potentials, spin, kpoints,
              plane_wave_basis, bloch_states,
              phi, H3phi, ost);
        if (am_i_mpi_rank0) { my_clock.print_time_from_save(ost, "calculating the tc-3body term (3b3)"); }

        tc3b3(parallelization,
              method,
              crystal_structure,
              potentials, spin, kpoints,
              plane_wave_basis, bloch_states,
        ...
        tc3b4(parallelization,
              method,
              crystal_structure,
              potentials, spin, kpoints,
              plane_wave_basis, bloch_states,
              phi, H3phi, ost);
        if (am_i_mpi_rank0) { my_clock.print_time_from_save(ost, "calculating the tc-3body term (3b4)"); }

        tc3b6(parallelization,
              method,
              crystal_structure,
              potentials, spin, kpoints,
              plane_wave_basis, bloch_states,
              phi, H3phi, ost);
        if (am_i_mpi_rank0) { my_clock.print_time_from_save(ost, "calculating the tc-3body term (3b6)"); }
*/
    }
