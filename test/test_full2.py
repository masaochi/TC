...
print('Test 1-13 were already done in test_full1.py...'+'\n')

## Example 14
print('\033[35m'+'Test 14/'+num_test+'\033[0m'+': HF SCF calculation for HEG')
copy_file('./example14/input.in')
check_tc(output, './example14/output.out', True)
print('\033[35m'+'Test 14/'+num_test+'\033[32m'+' passed.'+'\033[0m'+'\n')

## Example 15
subprocess.run('rm ./parameters.casl', shell=True)
print('\033[35m'+'Test 15/'+num_test+'\033[0m'+': TC SCF calculation for HEG')
copy_file('./example15/input.in')
check_tc(output, './example15/output.out', True)
print('\033[35m'+'Test 15/'+num_test+'\033[32m'+' passed.'+'\033[0m'+'\n')

## Example 16
subprocess.run('rm ./parameters.casl', shell=True)
print('\033[35m'+'Test 16/'+num_test+'\033[0m'+': BITC SCF calculation for HEG')
copy_file('./example16/input.in')
check_tc(output, './example16/output.out', True)
print('\033[35m'+'Test 16/'+num_test+'\033[32m'+' passed.'+'\033[0m'+'\n')

## Example 17
print('\033[35m'+'Test 17/'+num_test+'\033[0m'+': HF SCF calculation for bulk Si (spin-pol. calc.)')
copy_file('./example17/input.in')
check_tc(output, './example17/output.out', True)
print('\033[35m'+'Test 17/'+num_test+'\033[32m'+' passed.'+'\033[0m'+'\n')

# copy output files for the subsequent tests...
copy_scfoutput('./example20')

## Example 18
print('\033[35m'+'Test 18/'+num_test+'\033[0m'+': TC SCF calculation for bulk Si (spin-pol. calc.)')
copy_file('./example18/input.in')
copy_file('./example18/parameters.casl')
check_tc(output, './example18/output.out', True)
print('\033[35m'+'Test 18/'+num_test+'\033[32m'+' passed.'+'\033[0m'+'\n')

# copy output files for the subsequent tests...
copy_scfoutput('./example21')

## Example 19
print('\033[35m'+'Test 19/'+num_test+'\033[0m'+': BITC SCF calculation for bulk Si (spin-pol. calc.)')
copy_file('./example19/input.in')
copy_file('./example19/parameters.casl')
check_tc(output, './example19/output.out', True)
print('\033[35m'+'Test 19/'+num_test+'\033[32m'+' passed.'+'\033[0m'+'\n')

# copy output files for the subsequent tests...
copy_scfoutput('./example22')

## Example 20
print('\033[35m'+'Test 20/'+num_test+'\033[0m'+': HF BAND calculation for bulk Si (spin-pol. calc.)')
...
print('\033[35m'+'Test 20/'+num_test+'\033[32m'+' passed.'+'\033[0m'+'\n')

## Example 21
print('\033[35m'+'Test 21/'+num_test+'\033[0m'+': TC BAND calculation for bulk Si (spin-pol. calc.)')
copy_file('./example21/input.in')
copy_file('./example21/parameters.casl')
...
print('\033[35m'+'Test 21/'+num_test+'\033[32m'+' passed.'+'\033[0m'+'\n')

## Example 22
print('\033[35m'+'Test 22/'+num_test+'\033[0m'+': BITC BAND calculation for bulk Si (spin-pol. calc.)')
copy_file('./example22/input.in')
copy_file('./example22/parameters.casl')
...
print('\033[35m'+'Test 22/'+num_test+'\033[32m'+' passed.'+'\033[0m'+'\n')

## Example 23
print('\033[35m'+'Test 23/'+num_test+'\033[0m'+': HF fake SCF calculation for bulk Si (spin-pol. calc.)')
copy_file('./example23/input.in')
check_tc(output, './example23/output.out', True)
print('\033[35m'+'Test 23/'+num_test+'\033[32m'+' passed.'+'\033[0m'+'\n')

## Example 24
print('\033[35m'+'Test 24/'+num_test+'\033[0m'+': TC fake SCF calculation for bulk Si (spin-pol. calc.)')
copy_file('./example24/input.in')
copy_file('./example24/parameters.casl')
check_tc(output, './example24/output.out', True)
print('\033[35m'+'Test 24/'+num_test+'\033[32m'+' passed.'+'\033[0m'+'\n')

## Example 25
print('\033[35m'+'Test 25/'+num_test+'\033[0m'+': BITC fake SCF calculation for bulk Si (spin-pol. calc.)')
copy_file('./example25/input.in')
copy_file('./example25/parameters.casl')
check_tc(output, './example25/output.out', True)
print('\033[35m'+'Test 25/'+num_test+'\033[32m'+' passed.'+'\033[0m'+'\n')

remove_temporary_files()

print('Remaining tests can be done with test_full3.py...'+'\n')
